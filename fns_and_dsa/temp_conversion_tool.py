...
def main():
    try:
        ...
        temp_input_val = input("Enter the temperature to convert: ")
        temp_input = float(temp_input_val)
        ...
        if unit_input == "F":
            ...
            print("Invalid unit. Please select C for celsius and F for Fahrenheit")
    except ValueError:
